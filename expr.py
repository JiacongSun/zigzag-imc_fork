...
def experiment_1_literature_trend():
    ...
    data = np.array([
            ...
            ["10.1109/ISSCC42613.2021.9365766",                         2021, "DIMC", 22, 8, 24.7,           0.917,             0.917/0.202,              64*1024/8/8,       0.202,             None,       None,               20], ###
            ...
            ["10.1109/ISSCC42614.2022.9731645",                         2022, "DIMC", 28, 8, 12.5,           1.48,              0.221,                    24*8*1024/8/8,     1.48/0.221,        6.8266,     108*1024*1024,      21],  # BERT-Base (Transformer) ###
            # ["10.1109/JSSC.2021.3061508",                               2021, "DIMC", 65, 8, 2.06*4,         0.006*4,           0.006*4/0.2272,           2*8*1024/8/8,      0.2272,            1,          60*1024,            3],  # LeNet-5
            ["10.1109/VLSITechnologyandCir46769.2022.9830438",          2022, "DIMC", 12, 8, 30.3,           0.336,             41.6/4,                   1*8*1024/8/8,      0.336/(41.6/4),    None,       None,               22], ###
            # ["10.1109/ISSCC42614.2022.9731545",                         2022, "DIMC", 28, 8, 27.38,          0.0055,            0.0055/0.03,              4*8*1024/8/8,      0.03,              None,       None,               25],
            ["10.1109/ISSCC42614.2022.9731659",                         2022, "DIMC", 28, 8, 1108/64,        9.175/64,          9.175/64/0.033,           2*8*1024/8/8,      0.033,             1,          None,               26],
            ["10.1109/ESSCIRC59616.2023.10268774",                      2023, "DIMC", 16, 8, 23.8,           0.182,             0.364,                    128*8*1024/8/8,    0.182/0.364,       0.5056,     None,               28],  # Weijie's design
            ["10.1109/ISSCC42613.2021.9365788",                         2021, "AIMC", 16, 8, 30.25,          2.95,              0.118,                    589*8*1024/8/8,    2.95/0.118,        25,         25.6*1024*1024,     9],  # resnet50
            # ["10.1109/ESSCIRC59616.2023.10268725",                      2023, "DIMC", 28, 8, 22.4,           1.46*0.0159,       1.46,                     2*8*1024/8/8,      0.0159,            None,       None,               28],
            ["10.1109/ISSCC42615.2023.10067360",                        2023, "DIMC", 28, 8, 2.52,           3.33,              0.85,                     144*8*1024/8/8,    3.33/0.85,         3.93,       None,               29],
            ...
            ["10.1109/CICC57935.2023.10121308",                         2023, "DIMC", 28, 8, 711/2/8,        1.152/16,          1.152/16/(0.636*0.148),   1.152*8*1024/8/8, (0.636*0.148),      None,       268346/2,           30],  # 4b resnet20
            # ["10.1109/CICC57935.2023.10121243",                         2023, "AIMC", 65, 8, 1.4,            1.104/64,          1.104/64/7,               16*8*1024/8/8,     7,                 7,          268346,             5],  # 4-8b resnet20
            ["10.1109/CICC57935.2023.10121221",                         2023, "DIMC", 28, 8, 40.16*(1/0.36), 0.318,             1.25,                     32*8*1024/8/8,     0.318/1.25,        2.03,       77360,              31],
            ...
            ["10.23919/VLSICircuits52068.2021.9492444",                 2021, "AIMC", 28, 8, 5796/64,        6.144/64,          6.144/64/0.51,            36.8*8*1024/8/8,   0.51,              None,       8970,               16],  # custom networks
            ["https://ieeexplore.ieee.org/abstract/document/9508673",   2021, "DIMC", 28, 8, 588/64,         4.9/64,            4.9/64/20.9,              432*8*1024/8/8,    20.9,              20.9,       11.7*1024*1024/8,   32],  # resnet18
            ["10.1109/ISSCC42614.2022.9731657",                         2022, "AIMC", 28, 8, 45.7/2*3/8,     0.97/2*3/8,        0.97/2*3/8/(0.436*0.212), 170*8*1024/8/8,    (0.436*0.212),     8.702,      16*1024*1024,       17],  # YOLO-Tiny
            ["10.1109/TCSI.2023.3244338",                               2023, "AIMC", 28, 8, 16.1/4,         0.0128/4,          0.0128/4/(0.22*0.26),     2*8*1024/8/8,      (0.22*0.26),       None,       5642,               19],  # custom network
