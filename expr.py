...
def experiment_1_literature_trend():
    ...
    data = np.array([
            ...
            ["10.1109/ISSCC42613.2021.9365766",                         2021, "DIMC", 22, 8, 24.7,           0.917,             0.917/0.202,              64*1024/8/8,       0.202,             None,       None,               22],
            ...
            ["10.1109/ISSCC42614.2022.9731645",                         2022, "DIMC", 28, 8, 12.5,           1.48,              0.221,                    24*8*1024/8/8,     1.48/0.221,        6.8266,     108*1024*1024,      10],  # BERT-Base (Transformer)
            ["10.1109/JSSC.2021.3061508",                               2021, "DIMC", 65, 8, 2.06*4,         0.006*4,           0.006*4/0.2272,           2*8*1024/8/8,      0.2272,            1,          60*1024,            3],  # LeNet-5
            ["10.1109/VLSITechnologyandCir46769.2022.9830438",          2022, "DIMC", 12, 8, 30.3,           0.336,             41.6/4,                   1*8*1024/8/8,      0.336/(41.6/4),    None,       None,               24],
            ...
            ["10.1109/CICC57935.2023.10121221",                         2023, "DIMC", 28, 8, 40.16*(1/0.36), 0.318,             1.25,                     32*8*1024/8/8,     0.318/1.25,        2.03,       77360,              4],
            ...
            ["10.23919/VLSICircuits52068.2021.9492444",                 2021, "AIMC", 28, 8, 5796/64,        6.144/64,          6.144/64/0.51,            36.8*8*1024/8/8,   0.51,              None,       8970,               19],  # custom networks
            ["https://ieeexplore.ieee.org/abstract/document/9508673",   2021, "DIMC", 28, 8, 588/64,         4.9/64,            4.9/64/20.9,              432*8*1024/8/8,    20.9,              20.9,       11.7*1024*1024/8,   6],  # resnet18
            ["10.1109/ISSCC42614.2022.9731657",                         2022, "AIMC", 28, 8, 45.7/2*3/8,     0.97/2*3/8,        0.97/2*3/8/(0.436*0.212), 170*8*1024/8/8,    (0.436*0.212),     8.702,      16*1024*1024,       7],  # YOLO-Tiny
            ["10.1109/TCSI.2023.3244338",                               2023, "AIMC", 28, 8, 16.1/4,         0.0128/4,          0.0128/4/(0.22*0.26),     2*8*1024/8/8,      (0.22*0.26),       None,       5642,               20],  # custom network
